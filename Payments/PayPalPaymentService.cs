...
namespace Infrastructure.Payments
{
    public class PayPalPaymentService : IPaymentService
    {
        ...
        public PaymentPostData GeneratePostDataFor(OrderPaymentRequest orderRequest)
        {
            ...
            paymentPostData.PaymentPostToUrl = _applicationSettings.PayPalPaymentPostToUrl;
            ...
            postDataAndValue.Add("business", _applicationSettings.PayPalBusinessEmail);
        ...
        {
            string paypalUrl = _applicationSettings.PayPalPaymentPostToUrl;
